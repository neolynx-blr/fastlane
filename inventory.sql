...
create table vendor_item_history (id serial primary key,vendor_id integer not null,item_code varchar(128),version_id bigint not null,barcode bigint not null,mrp decimal(8, 2) not null,price decimal(8, 2),image_json varchar(512),discount_type smallint,discount_value decimal(8,2),product_id bigint not null,name varchar(256) not null,description varchar(1024),tag_line varchar(256)); 
create table vendor_item_master (id serial primary key,vendor_id integer not null,item_code varchar(128),product_id bigint not null,version_id bigint not null,barcode bigint not null,mrp decimal(8, 2) not null,price decimal(8, 2),image_json varchar(512),discount_type smallint,discount_value decimal(8,2),name varchar(256) not null,description varchar(1024),tag_line varchar(256),created_on timestamp not null default now(), constraint vim_uniq_constraint unique (barcode, vendor_id)); 
create table product_master (id serial primary key,barcode bigint not null,name varchar(256) not null,description varchar(1024),tag_line varchar(256),vendor_id varchar(4096) not null,image_json varchar(512), constraint pm_uniq_constraint unique (barcode, vendor_id));
...
insert into vendor_item_master (vendor_id,item_code,product_id,version_id,barcode,mrp,price,image_json,discount_type,discount_value,name varchar(256) not null,description varchar(1024),tag_line varchar(256),created_on) values (1, 'I0001', 3, 21, 1234, 2.63, 2.47, null, null, null,'X-Name', 'X-Description', 'X-Tagline', now());
insert into vendor_item_master (vendor_id,item_code,product_id,version_id,barcode,mrp,price,image_json,discount_type,discount_value,name varchar(256) not null,description varchar(1024),tag_line varchar(256),created_on) values (1, 'I0004', 6, 3, 1237, 3.63, 3.47, null, null, null, 'A-Name', 'A-Description', 'A-Tagline',now());
