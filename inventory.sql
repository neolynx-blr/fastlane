...
create table product_master (id serial primary key,barcode bigint not null unique,name varchar(256) not null,description varchar(1024),tag_line varchar(256),vendor_id varchar(4096) not null,image_json varchar(512));
